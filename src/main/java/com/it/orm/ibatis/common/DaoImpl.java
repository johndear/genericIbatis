package com.it.orm.ibatis.common;
...
import com.it.common.entity.BaseDto;
...
//		}
	 ...
	 *             存储过程调用异常
	 */
	public void callPrc(String prcName, Dto prcDto) throws Exception {
...
//			throw new Exception(prcName, "存储过程没有返回状态码appCode");
//		} else {
//			if (!prcDto.getAsString("appCode").equals(callPrcSuccessFlag)) {
//				throw new Exception(prcName, prcDto.getAsString("appCode"), prcDto.getAsString("errorMsg"));
//			}
//		}
	}
	 ...
	 *             存储过程调用异常
	 */
	public void callPrc(String prcName, Dto prcDto, String successFlag) throws Exception {
//		// getSqlMapClientTemplate().queryForObject(prcName, prcDto);
//		getSqlMapClientTemplate().insert(prcName, prcDto);
//		if (G4Utils.isEmpty(prcDto.getAsString("appCode"))) {
//			throw new Exception(prcName, "存储过程没有返回状态码appCode");
